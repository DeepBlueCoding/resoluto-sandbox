...
[Get started](https://deepbluecoding.github.io/resoluto-sandbox/0.1.0-rc1/getting-started/index.md) [API reference](https://deepbluecoding.github.io/resoluto-sandbox/0.1.0-rc1/api/sandbox/index.md)
...
The base install is pydantic-only; concrete runtimes and conduits with platform dependencies import lazily. See **[Getting started](https://deepbluecoding.github.io/resoluto-sandbox/0.1.0-rc1/getting-started/index.md)** for usage, **[Backends](https://deepbluecoding.github.io/resoluto-sandbox/0.1.0-rc1/backends/index.md)** for the `local` / `k8s` substrates, **[Networking](https://deepbluecoding.github.io/resoluto-sandbox/0.1.0-rc1/networking/index.md)** for egress control, and the **[API reference](https://deepbluecoding.github.io/resoluto-sandbox/0.1.0-rc1/api/sandbox/index.md)** for the full surface.
