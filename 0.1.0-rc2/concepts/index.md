...
Inject a configured `SubstrateBackend` — the image is not a `Sandbox` constructor concern. See [Getting started → The k8s backend](https://deepbluecoding.github.io/resoluto-sandbox/0.1.0-rc2/getting-started/#the-k8s-backend) for the full wiring.
