...
No facade changes are needed — `Sandbox` holds any `Backend` instance. `Conduit` and `SandboxRuntime` are the other two extension points: implement the ABC, pass your instance to `Sandbox`, and the facade drives it unchanged. See the [Runtime & Contracts](https://deepbluecoding.github.io/resoluto-sandbox/0.1.0-rc4/api/runtime/index.md) reference for the full protocol each one must satisfy.
