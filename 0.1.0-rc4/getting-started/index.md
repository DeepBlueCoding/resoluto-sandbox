...
`backend="k8s"` runs each program in a short-lived Kata microVM pod, rendezvousing through an S3/minio `Conduit`. For anything beyond the defaults, inject a configured [`SubstrateBackend`](https://deepbluecoding.github.io/resoluto-sandbox/0.1.0-rc4/api/runtime/#resoluto.sandbox.SubstrateBackend):
...
See **[Concepts](https://deepbluecoding.github.io/resoluto-sandbox/0.1.0-rc4/concepts/index.md)** for the run lifecycle, **[Backends](https://deepbluecoding.github.io/resoluto-sandbox/0.1.0-rc4/backends/index.md)** for the substrate details, and **[Networking](https://deepbluecoding.github.io/resoluto-sandbox/0.1.0-rc4/networking/index.md)** for per-run egress control.
