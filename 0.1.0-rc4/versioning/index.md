...
- **`0.MINOR`** may introduce breaking changes — always called out in the [changelog](https://deepbluecoding.github.io/resoluto-sandbox/0.1.0-rc4/changelog/index.md).
